        ...
        <div class="header">
            ...
            <div class="third">
                <form action="{{ route('blog.create') }}" method="post">
                    ...
                    <input name="topic_name" style="position: absolute; top:60px; left: 180px; border:none; border-radius: 8px; height: 25px; width:250px;" type="text">
                        <br>
                            <br>
                                <label style="position: absolute; top:160px; left:50px; font-size: 16px; font-weight: bolder;">
                                    Details
                                </label>
                                <textarea name="details" style="position: absolute; top: 130px; left: 180px; height: 70px; width: 250px; border-radius:8px; border:none;">
                                </textarea>
                                <br>
                                    <br>
                                        <input class="btn" style="position: absolute; top:220px; left: 220px; height: 30px; width: 150px; border-radius: 8px; border:none; cursor: pointer; " type="submit" value="Submit">
